...
public class TransactionStatusInquiryService {
	...
	public String buildRequestISOMessage(TransactionStatusInquiryReq req) throws Exception {
        try {
	...
	public ResponsesISO buildResponseISOMessage(TransactionStatusInquiryReq  req) throws Exception {
        try {
