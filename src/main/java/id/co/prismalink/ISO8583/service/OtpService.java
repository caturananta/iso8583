...
public class OtpService {
	...
	public String buildRequestISOMessage(OtpReq req) throws Exception {
        try {
	...
	public ResponsesISO buildResponseISOMessage(OtpReq req) throws Exception {
        try {
	...
	public ResponsesISO buildResponseMaskISOMessage(OtpReq req) throws Exception {
        try {
